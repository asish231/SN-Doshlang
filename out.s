...
_main:
    ...
    add x0, x0, print_fmt_str@PAGEOFF     adrp x1, print_val0@@PAGE
    add x1, x1, print_val0@@PAGEOFF
    sub sp, sp, #16
    str x1, [sp]
    bl _printf
    add sp, sp, #16     adrp x9, store_val1@@PAGE
    ldr x10, [x9, store_val1@@PAGEOFF]
    stur x10, [x29, #8]]     adrp x9, store_va0]
...
L_snl_7:
    ...
    adrp x0,    mov w0, #0
    mov sp, x29
    ldp x29, x30, [sp], #16    adrp x9, print_val_6@PAGE
